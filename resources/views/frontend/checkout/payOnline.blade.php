...
<head>
    ...
    <link rel="stylesheet" href="{{asset('FrontEnd/assets/css/payonline.css')}}">
</head>
...
<body>
    ...
    <div class="container">
        <div class="left">
            <div class="headphone">
                <img src="{{asset('FrontEnd/assets/img/bank/ACB.png')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/DA.jpg')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/PVC.jpg')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/agribank.png')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/QD.jpg')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/TCB.jpg')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/VCB.png')}}" alt="">
                <img src="{{asset('FrontEnd/assets/img/bank/BIDV.png')}}" alt="">
            ...
            <form action="">
                <div class="row card-holder">
                    ...
                    <div class="select-card">
                        <img src="{{asset('FrontEnd/assets/img/bank/master.png')}}" alt="">
                        <select name="" id="">
