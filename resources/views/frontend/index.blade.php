...
<div class="slider_area">
    <div class="slider_list  owl-carousel">
        <div class="single_slide" style="background-image: url(../FrontEnd/assets/img/slider/1.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-12">
        ...
        <div class="single_slide" style="background-image: url(../FrontEnd/assets/img/slider/2.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="slider__content">
                ...
                <div class="col-lg-2">
                    <div class="single__product">
                        <div class="single_product__inner">
                            <span class="new_badge">{{ round($pro->votes->avg('point')) ?? 0 }} <i class="fa fa-star"></i></span>
                            <div class="product_img">
                                <a href="{{route('details.product',$pro->id)}}">
                                    <img src="{{url('/img/products',$pro->product_image)}}" height="100px" alt="">
                                </a>
                            </div>
                            <div class="product__content text-center">
                                ...
                                <div class="product__hover">
                                    <ul>
                                        ...
                                        <li><a class="cart-fore" href="#" data-toggle="modal" data-target="#my_modal{{$pro->id}}" title="Quick View"><i class="ion-android-open"></i></a></li>
                ...
                <div class="shop_product_head d-flex justify-content-between mb-30">
                    ...
                    <div class="home_shop_product text-right">
                        <ul class="product-tab-list nav d-flex flex-wrap justify-content-end" role="tablist">
                            ...
                            <li><a href="#flowers" data-toggle="tab" role="tab" aria-selected="false" aria-controls="flowers"> Trái cây </a></li>
                            <li><a href="#rices" data-toggle="tab" role="tab" aria-selected="false" aria-controls="organics">Gạo </a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single__product_2">
                        <div class="product_img px-auto">
                            <a href="{{route('details.product',$product->id)}}">
                                <img src="{{url('img/products',$product->product_image)}}" alt="">
                            </a>
                        </div>
                        <div class="product__content text-center">
                            <div class="product_title">
                                            ...
                                            <div class="single_product__inner">
                                                ...
                                                <div class="product_img">
                                                    <a href="{{route('details.product',$veg->id)}}">
                                                        <img src="{{url('img/products',$veg->product_image)}}" height="100px" alt="">
                                                    </a>
                                                </div>
                                                <div class="product__content text-center">
                                                    <div class="produc_desc_info">
                                                        <div class="product_title">
                                                            <h4><a href="product-details.html">{{$veg->product_name}}</a>
                                                            </h4>
                                                        </div>
                                                        <div class="product_price">
                                                    ...
                                                    <div class="product__hover">
                                                        <ul>
                                                            ...
                                                            <li><a class="cart-fore" href="#" data-toggle="modal" data-target="#my_modal{{$veg->id}}" title="Quick View"><i class="ion-android-open"></i></a></li>
                                                ...
                                                <div class="product__content text-center">
                                                    ...
                                                    <div class="product__hover">
                                                        <ul>
                                                            ...
                                                            <li><a class="cart-fore" href="#" data-toggle="modal" data-target="#my_modal{{$veg->id}}" title="Xem nhanh"><i class="ion-android-open"></i></a></li>
                                                            {{-- <li><a href="product-details.html"><i
                                                                        class="ion-clipboard"></i></a></li> --}}
                                                        </ul>
                                                    </div>
                ...
                <div class="col-lg-2">
                    <div class="single__product">
                        <div class="single_product__inner">
                            ...
                            <div class="product_img">
                                <a href="{{route('details.product',$pro->id)}}">
                                    <img src="{{url('/img/products',$pro->product_image)}}" height="100px" width="" alt="">
                                </a>
                            </div>
                            <div class="product__content text-center">
                                <div class="produc_desc_info">
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$vegetables2[0]->id)}}">
                                    <img src="{{url('img/products',$vegetables2[0]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$vegetables2[0]->product_name}}</a></h4>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$vegetables2[1]->id)}}">
                                    <img src="{{url('img/products',$vegetables2[1]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$vegetables2[1]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$vegetables2[2]->id)}}">
                                    <img src="{{url('img/products',$vegetables2[2]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$vegetables2[2]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$vegetables2[3]->id)}}">
                                    <img src="{{url('img/products',$vegetables2[3]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$vegetables2[3]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$flowers2[2]->id)}}">
                                    <img src="{{url('img/products',$flowers2[2]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$flowers2[2]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$flowers2[3]->id)}}">
                                    <img src="{{url('img/products',$flowers2[3]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$flowers2[3]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$flowers2[0]->id)}}">
                                    <img src="{{url('img/products',$flowers2[0]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$flowers2[0]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                        ...
                        <div class="single_small_product mb-30">
                            <div class="product_thumb">
                                <a href="{{route('details.product',$flowers2[1]->id)}}">
                                    <img src="{{url('img/products',$flowers2[1]->product_image)}}" alt="">
                                </a>
                            </div>
                            <div class="product_content">
                                <h4><a href="product-details.html">{{$flowers2[1]->product_name}}</a></h4>
                                <div class="product_ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
