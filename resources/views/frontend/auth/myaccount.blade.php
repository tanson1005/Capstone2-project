            ...
            <div class="row">
                <div class="col-sm-12 col-md-3 col-lg-3">
                    ...
                    <ul role="tablist" class="nav flex-column dashboard-list">
                        ...
                        <li> <a href="#products" data-toggle="tab" class="nav-link">Mặt hàng đã mua</a></li>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="" data-toggle="modal" data-target="#my_modal{{$data->id}}" class="view">view</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->getProduct->product_description }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <div class="login-form-container">
                                    <div class="account-login-form">
                                        <form method="POST">
                                            ...
                                            <input type="text" name="date" value="{{ auth()->user()->created_at }}" readonly>
                                            @if (session('message'))
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @foreach ($dataOrders[$data->id] as $data )
                                    <tr>
                                        <td>{{$data->created_at}}</td>
