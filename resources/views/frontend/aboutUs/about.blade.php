...
<div class="breadcrumb_container continer">
    <div class="row">
        <div class="col-12">
            <nav>
                <ul>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 col-md-12 text-center">
                <div class="about_section_one">
                    ...
                    <p>Thương hiệu Organic Food của chúng tôi là một trong những thương hiệu xuất khẩu nông sản lớn nhất Việt Nam.
                        ...
                        Thực hiện chế độ đãi ngộ thỏa đáng về vật chất và tinh thần nhằm khuyến khích cán bộ công nhân viên
    ...
    <div class="container-fluid">
        <div class="row no-gutters">
            <div class="col-xl-6 col-lg-12 col-md-12">
                <div class="video__wrape__area" style="background-image:url(../FrontEnd/assets/img/banner/about1.jpg)">
                    <div class="video__inner">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/i493IC18WvY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-12 col-md-12">
    ...
    <div class="container">
        ...
        <div class="row no-gutters">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="single_team">
                    <div class="team__imge">
                        <a href="#"><img src="../FrontEnd/assets/img/banner/team1.jpg" alt=""></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="single_team">
                    <div class="team__imge">
                        <a href="#"><img src="../FrontEnd/assets/img/banner/team2.jpg" alt=""></a>
                    </div>
                    <div class="team_hover_inpo">
                        <div class="team_hover_action">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="single_team team__three">
                    <div class="team__imge">
                        <a href="#"><img src="../FrontEnd/assets/img/banner/team4.jpg" alt=""></a>
                    </div>
                    <div class="team_hover_inpo">
                        <div class="team_hover_action">
...
<div class="about_testimonial_area mb-65" style="background-image:url(../FrontEnd/assets/img/banner/testimonial4.jpg)">
