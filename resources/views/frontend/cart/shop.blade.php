                 ...
                 <div class="block_categories">
                     <div class="category_top_menu widget">
                         ...
                         <ul class="shop_toggle">
                             ...
                             <li class="has-sub"><a href="{{url('/shop/danhmuc')}}/{{$category->group_name}}">{{ $category->group_name}}
                                 </a>
         ...
         <div class="col-lg-9 col-md-12 col-12">
             <div class="categories_banner">
                 <div class="categories_banner_inner">
                     <img src="../FrontEnd/assets/img/banner/shop.jpg" alt="">
                 </div>
                 <h3>Cửa hàng</h3>
             </div>
                                         ...
                                         <div class="product__content text-center">
                                             <div class="produc_desc_info">
                                                 ...
                                                 <div class="product_price">
                                                     <input type="hidden" min="1" value="1" name="quantity_modal" class="cart-plus-minus-box quantity">
                                                     <p>{{number_format($pro->product_price)}} Vnd</p>
                                                 </div>
                                             </div>
                                             <div class="product__hover">
                                                 <ul>
                                                     <li><a data-id="{{$pro->id}}" href="javascript:" class="add__cart" role="button"><i class="ion-android-cart"></i></a>
                                                     </li>
                                                     <li><a class="cart-fore" href="#" data-toggle="modal" href="javascript:" data-target="#my_modal{{$pro->id}}" title="Xem nhanh"><i class="ion-android-open"></i></a>
                                                     </li>
                                                     <li><a href="{{route('details.product',$pro->id)}}"><i class="ion-clipboard"></i></a>
                                                     </li>
                                                 </ul>
                                             </div>
                                         </div>
                                             ...
                                             <div class="quickview_plus_minus">
                                                 ...
                                                 <div class="quickview_plus_minus_inner">
                                                     <div class="cart-plus-minus">
                                                         <input type="number" min="1" value="1" name="quantity_modal" class="cart-plus-minus-box quantity">
                                                     </div>
                                                     <div class="add_button add_modal">
                                                         <button type="button" class="btn_add_cart" data-id="{{$pro->id}}"> Thêm giỏ hàng</button>
                                                     </div>
                                                 </div>
                                             </div>
 ...
 <script>
     ...
     $(".add__cart").on('click', function(e) {
         ...
         $.ajax({
             type: "GET"
             , url: "{{ route('frontend') }}/add-to-cart/" + id
             , data: {
                 id: id
                 , quantity: quantity
             }
