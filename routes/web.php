...
Route::group(['prefix' => 'frontend'], function () {
    ...
    Route::get('/qr-detail/{id}', [FrontEndProductController::class, 'detailsQR'])->name('details.qr');
    ...
    Route::post('vote/{id}', [FrontEndProductController::class, 'voteProduct'])->name('vote')->middleware('auth');
    Route::post('comment', [FrontEndCommentController::class, 'comment'])->name('comment')->middleware('auth');
});
